...
Réhydrate le ticket : `python3 -m sdlc.cli --project HIA get <STORY>`.
...
3. **Écris** `hia-sdlc/<EPIC>/stories/<STORY>/spec-func.md` (Comportement + Critères G/W/T).
4. **Avance l'état** : `python3 -m sdlc.cli --project HIA set-status <STORY> spec_func`.
